...
new const g_szGameOptionKeys[CAC_GAMEOPTION__ALL][] = {"vehicle_blips", "manual_reloading", "drive_on_water", "fireproof", "sprint", "infinite_sprint", "infinite_oxygen", "infinite_ammo", "night_vision", "thermal_vision"};
