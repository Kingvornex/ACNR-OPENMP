...
Added /anopm (Admin No PM(SendAdminMessage))
...
Removed Comet vehicle from carshop 
...
Removed /afk & /back because of /unfreeze bug
 [ but you can fix this whit writhing TogglePlayerControllable(playerid,false); in onplayerupdate like god mode ]
...
Now you can't use /phone in vehicle [ but you can change it to let players to use /phone and hide phone when they are in vehicle ]
...
Now vehicles can attach to twos
...
Change /vbike , /vcar , /gcar & /car vehicles to temporary vehicles

Stopped respawning shop vehicles with /respawncars
...
Respawn shop vehicles with /respawncars
